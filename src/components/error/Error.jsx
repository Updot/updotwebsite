  ...
  return (
    <div className={`container ${classes.error}`}>
      <div className={classes["error-text-container"]}>
        <h2 className={classes["error-heading"]}>Oops!!!</h2>
        <h3 className={classes["error-text"]}>Page not found :(</h3>
      </div>
      <div className={classes["error-feature"]}>
        <div className={classes["error-image-container"]}>
          <img className={classes["updot-u"]} src={updotU} alt="updot u" />
        ...
        <div className={classes["error-redirect-link"]}>
          <Link className={classes["error-link"]} to="/">
            Head TO <img src={updot} alt="updot" /> ?
          </Link>
        </div>
      </div>
    </div>
